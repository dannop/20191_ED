...
void selection_sort_disco(FILE *arq, int tam) {
    //TODO: Implementar essa função usando ordenação direto em disco (sem copiar o conteúdo do arquivo para um vetor em memória)
    rewind(arq);
    int i;
    for(int j = 2; j <= tam; j++){
